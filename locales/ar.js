(function () {
  const locale = {
    ...
    strings: {
      docTitle: "سياسة الخصوصية وأمان البيانات - تطبيق تي إكليسيا | كنيسة السيدة العذراء والشهيد مارجرجس - بولاق الدكرور - وسط الجيزة",
      metaDescription: "سياسة الخصوصية الرسمية لتطبيق تي إكليسيا (TeEcclesia) - كنيسة السيدة العذراء والشهيد مارجرجس - بولاق الدكرور - وسط الجيزة. متوافق 100% مع سياسات عائلات Google Play وحماية خصوصية الأطفال من سن 9 سنوات.",
      ...
      heroSubtitle: "البيان الرسمي لكيفية قيام تطبيق تي إكليسيا (TeEcclesia) بجمع واستخدام وحماية بياناتك وبيانات أبنائك بما يتوافق مع أعلى معايير الخصوصية ومتطلبات سياسة عائلات متجر Google Play.",
      ...
      overviewP1: "تطبيق <strong>تي إكليسيا (TeEcclesia)</strong> هو منصة رقمية رعوية وتنظيمية غير تجارية، مملوكة ومدارة بالكامل بواسطة <strong>كنيسة السيدة العذراء والشهيد مارجرجس - بولاق الدكرور - وسط الجيزة</strong>. يهدف التطبيق إلى خدمة أسر الكنيسة وشعبها من مختلف الأعمار، وتنظيم أنشطة التربية الكنسية (مدارس الأحد)، والقداسات، والاجتماعات الروحية، ومدرسة الشمامسة.",
      ...
      secChildrenItem2: "<strong>شهادة الميلاد الرسمية كبديل للبطاقة:</strong> للأطفال دون 13 عاماً، يطلب التطبيق شهادة الميلاد المميكنة الصادرة رسمياً لإثبات الهوية والسن ومنع انتحال الشخصيات، بدلاً من بطاقة الرقم القومي المخصصة للبالغين.",
      ...
      secNoAdsP1: "يتميز تطبيق تي إكليسيا بخلوه التام والشامل من أي محتوى إعلاني، أو نوافذ ترويجية، أو أدوات تتبع سلوكية وتجارية. التطبيق لا يجمع ولا يستخدم المعرّف الإعلاني (Google Advertising ID) إطلاقاً، ولا يتضمن أي مكتبات أو أدوات برمجية إعلانية تابعة لأطراف ثالثة.",
      ...
      footerChurch: "كنيسة السيدة العذراء والشهيد مارجرجس - بولاق الدكرور - وسط الجيزة — تطبيق تي إكليسيا (TeEcclesia)",
