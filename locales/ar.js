(function () {
  const locale = {
    ...
    strings: {
      ...
      secRightsTitle: "حقوق المستخدمين المسجلين",
      secRightsDesc: "يحق لكل مستخدم مسجل في التطبيق في أي وقت ممارسة الحقوق القانونية التالية:",
      secRightsItem1: "<strong>حق الاطلاع والوصول:</strong> مراجعة كافة البيانات الشخصية المسجلة الخاصة به عبر التطبيق.",
      ...
      secRightsItem4: "<strong>حق الاستفسار:</strong> التواصل المباشر مع إدارة الكنيسة المسؤولة عن الخصوصية للاستفسار عن أي بند يخص بياناته.",
      secContactTitle: "تواصل معنا والاستفسارات الرسمية",
      secContactDesc: "إذا كانت لديك أي أسئلة أو استفسارات تتعلق بسياسة الخصوصية هذه أو رغبت في ممارسة حقوقك بشأن بياناتك، يسعدنا التواصل معك عبر القنوات الرسمية التالية:",
