(function () {
  const locale = {
    ...
    strings: {
      ...
      thDelete: "Deletable?",
      secRightsTitle: "Registered User Rights",
      secRightsDesc: "Every registered user holds the following legal rights regarding their stored data at any time:",
      secRightsItem1: "<strong>Right of Access:</strong> Review all personal information recorded for your account directly within the app.",
